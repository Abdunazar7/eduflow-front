      ...
      <div className="w-full max-w-md relative">
        ...
        <Card className="shadow-2xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl relative z-10">
          <CardHeader className="space-y-1 pb-6">
            <CardTitle className="text-2xl text-center">Xush kelibsiz</CardTitle>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-2 text-sm bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900/50 dark:to-purple-900/20 p-4 rounded-lg border border-indigo-100 dark:border-indigo-900/50">
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <p className="font-semibold text-indigo-700 dark:text-indigo-400">Platform Admin:</p>
                    <p className="text-gray-600 dark:text-gray-400">+998901234567</p>
                  </div>
                  <div>
                    <p className="font-semibold text-purple-700 dark:text-purple-400">Manager:</p>
                    <p className="text-gray-600 dark:text-gray-400">+998901234568</p>
                  </div>
                  <div>
                    <p className="font-semibold text-blue-700 dark:text-blue-400">Admin:</p>
                    <p className="text-gray-600 dark:text-gray-400">+998901234569</p>
                  </div>
                  <div>
                    <p className="font-semibold text-green-700 dark:text-green-400">Teacher:</p>
                    <p className="text-gray-600 dark:text-gray-400">+998901234570</p>
                  </div>
                  <div className="col-span-2">
                    <p className="font-semibold text-pink-700 dark:text-pink-400">Student:</p>
                    <p className="text-gray-600 dark:text-gray-400">+998901234571</p>
                  </div>
                </div>
                <div className="pt-3 border-t border-indigo-200 dark:border-indigo-800 mt-3">
                  <p className="font-semibold text-gray-700 dark:text-gray-300">Parol:</p>
                  <p className="text-gray-600 dark:text-gray-400 font-mono">demo123</p>
                </div>
              </div>
            </div>
          </CardContent>
