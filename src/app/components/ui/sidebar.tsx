...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      // HOVER SHU YERGA QO'SHILDI
      className={cn("group/menu-item relative rounded-md transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground", className)}
      {...props}
    />
  );
}
...
const sidebarMenuButtonVariants = cva(
  // HOVER KLASSLARI BU YERDAN OLIB TASHLANDI
